export const Icons = {
  ...
  youtubeFooter: {
    paths: [
      {
        d: 'M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505a3.016 3.016 0 0 0-2.122 2.136C0 8.057 0 12 0 12s0 3.943.501 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.016 3.016 0 0 0 2.122-2.136C24 15.943 24 12 24 12s0-3.943-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568Z',
      },
    ],
    class: 'h-4 w-4 shrink-0 fill-current text-neutral-700 dark:text-neutral-400',
    viewBox: '0 0 24 24',
  ...
  tiktokFooter: {
    paths: [
      {
        d: 'M19.615 3.049a9.933 9.933 0 0 1-2.664-.212 8.864 8.864 0 0 1-2.357-.83 8.89 8.89 0 0 1-1.915-1.43 8.89 8.89 0 0 1-1.43-1.914 8.864 8.864 0 0 1-.83-2.357 10.054 10.054 0 0 1-.212-2.664h-2.752a10.04 10.04 0 0 0 .254 2.86 8.875 8.875 0 0 0 .753 2.273 8.915 8.915 0 0 0 1.272 1.86 8.915 8.915 0 0 0 1.86 1.272 8.875 8.875 0 0 0 2.273.753 9.949 9.949 0 0 0 2.86.254v2.752a9.933 9.933 0 0 1-2.664-.212 8.864 8.864 0 0 1-2.357-.83 8.89 8.89 0 0 1-1.915-1.43 8.89 8.89 0 0 1-1.43-1.914 8.864 8.864 0 0 1-.83-2.357 10.054 10.054 0 0 1-.212-2.664h-2.752a10.04 10.04 0 0 0 .254 2.86 8.875 8.875 0 0 0 .753 2.273 8.915 8.915 0 0 0 1.272 1.86 8.915 8.915 0 0 0 1.86 1.272 8.875 8.875 0 0 0 2.273.753 9.949 9.949 0 0 0 2.86.254v2.752z',
      },
    ],
    class: 'h-4 w-4 shrink-0 fill-current text-neutral-700 dark:text-neutral-400',
    viewBox: '0 0 24 24',
  ...
  pinterestFooter: {
    paths: [
      {
        d: 'M12 0C5.373 0 0 5.372 0 12c0 5.084 3.163 9.426 7.627 11.174-.105-.949-.2-2.41.042-3.444.218-.937 1.407-5.965 1.407-5.965s-.354-.709-.354-1.754c0-1.644.953-2.87 2.142-2.87 1.012 0 1.5 0 1.5 1.116 0 1.017-.646 2.55-.981 3.97-.283 1.204.605 2.184 1.797 2.184 2.157 0 3.812-2.275 3.812-5.566 0-2.91-2.099-4.947-5.097-4.947-3.473 0-5.507 2.605-5.507 5.287 0 1.047.403 2.168.908 2.772a.366.366 0 0 1 .083.344c-.093.387-.299 1.272-.339 1.453-.054.224-.174.27-.384.163-1.435-.667-2.331-2.762-2.331-4.452 0-3.626 2.637-6.95 7.592-6.95 3.987 0 7.066 2.84 7.066 6.625 0 3.945-2.488 7.128-5.934 7.128-1.158 0-2.243-.602-2.616-1.315 0 0-.57 2.168-.708 2.694-.256.977-.95 2.2-.95 2.966 0 .766.057 1.466.088 2.087C18.555 20.847 24 16.932 24 12c0-6.627-5.373-12-12-12z',
      },
    ],
    class: 'h-4 w-4 shrink-0 fill-current text-neutral-700 dark:text-neutral-400',
    viewBox: '0 0 24 24',
  ...
  mapsFooter: {
    ...
    class: 'h-4 w-4 shrink-0 text-neutral-700 dark:text-neutral-400',
    viewBox: '0 0 24 24',
    fill: 'none',
    strokeWidth: '1.5',
    strokeLinecap: 'round',
  ...
  whatsapp: {
    paths: [
      {
        d: 'M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 0 1-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 0 1-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 0 1 2.893 6.994c-.003 5.45-4.435 9.884-9.882 9.884m8.413-18.297A11.815 11.815 0 0 0 12.05 0C5.495 0 .16 5.387.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 0 0 5.683 1.448h.005c6.554 0 11.89-5.387 11.893-11.893a11.821 11.821 0 0 1-3.48-8.413z',
      },
    ],
